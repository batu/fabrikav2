...
COLLECTION_COMPLETED = 1           # completed levels the Collection needs (arrive at 2)
SANCTUARY_COMPLETED = 6            # completed levels the Sanctuary needs (arrive at 7)
...
COVERAGE = {'sparrow': (2, 2), 'robin': (10, 50), 'bluebird': (25, 65)}
