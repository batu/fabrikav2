...
def test_finalize_cutout_key_gap_goes_transparent_and_plumage_hole_is_restored():
    ...
    a[10:14, 10:14, :3] = (250, 10, 250)       # near-pure key colour forced opaque = a real gap
    a[15:18, 15:18, :3] = (200, 80, 190)       # pink plumage: must stay opaque
    ...
    assert (out[15:18, 15:18, 3] == 255).all()
