...
| Placement | smart (vision-scored, `google/gemini-3.6-flash` since 2026-08-13; was 3.5-flash-lite, metered) | radius **38** (=58 × 2688/4096, canvas-scaled default); 36-candidate pool (floor 2×n), chunks scored in parallel | Deadzones include HUD band, banner band, hint chip, and the side edge-margins (below). The old n×4 floor silently doubled scoring calls (64 candidates / 4 serial calls at 16 birds). |
