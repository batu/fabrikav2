...
export default class Shop extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		const shop_fab_item_locked_shadow = this.add.rectangle(195, 530, 160, 176);
		shop_fab_item_locked_shadow.isFilled = true;
		shop_fab_item_locked_shadow.fillColor = 1519682;
		shop_fab_item_locked_shadow.fillAlpha = 0.1;
		...
		const shop_fab_item_locked_card = this.add.rectangle(195, 526, 160, 176);
		shop_fab_item_locked_card.isFilled = true;
		shop_fab_item_locked_card.fillColor = 15199984;
		shop_fab_item_locked_card.isStroked = true;
		shop_fab_item_locked_card.strokeColor = 11257804;
		shop_fab_item_locked_card.lineWidth = 2;
		...
		const shop_fab_item_locked_trophy = this.add.rectangle(195, 478, 54, 48);
		shop_fab_item_locked_trophy.isFilled = true;
		shop_fab_item_locked_trophy.fillColor = 2061917;
		...
		const shop_fab_item_locked_trophy_icon = this.add.image(195, 478, "icon_control_result_win");
		shop_fab_item_locked_trophy_icon.scaleX = 0.25;
		shop_fab_item_locked_trophy_icon.scaleY = 0.25;

		// shop.fab.item-locked-icon
		const shop_fab_item_locked_icon = this.add.image(217, 460, "progression_node_locked");
		shop_fab_item_locked_icon.scaleX = 0.2;
		shop_fab_item_locked_icon.scaleY = 0.2;

		// shop.fab.item-locked-detail
		const shop_fab_item_locked_detail = this.add.text(195, 551, "", {});
		shop_fab_item_locked_detail.setOrigin(0.5, 0.5);
		shop_fab_item_locked_detail.text = "Coming later";
		shop_fab_item_locked_detail.setStyle({ "color": "#3d5968", "fontFamily": "kenney_future_narrow", "fontSize": "15px" });

		// shop.fab.item-locked-status-surface
		const shop_fab_item_locked_status_surface = this.add.rectangle(195, 586, 132, 48);
		shop_fab_item_locked_status_surface.isFilled = true;
		shop_fab_item_locked_status_surface.fillColor = 13950946;
		shop_fab_item_locked_status_surface.isStroked = true;
		shop_fab_item_locked_status_surface.strokeColor = 11257804;
		shop_fab_item_locked_status_surface.lineWidth = 2;
		shop_fab_item_locked_status_surface.setRounded(16);

		// shop.fab.item-locked-status
		const shop_fab_item_locked_status = this.add.text(195, 586, "", {});
		shop_fab_item_locked_status.setOrigin(0.5, 0.5);
		shop_fab_item_locked_status.text = "LOCKED";
		shop_fab_item_locked_status.setStyle({ "color": "#3d5968", "fontFamily": "kenney_future_narrow", "fontSize": "14px" });
		...
		// shop.item.locked
		const shop_item_locked = this.add.text(195, 521, "", {});
		shop_item_locked.setOrigin(0.5, 0.5);
		shop_item_locked.text = "VIP Bundle";
		shop_item_locked.setStyle({ "color": "#173042", "fontFamily": "kenney_future_narrow", "fontSize": "18px" });
