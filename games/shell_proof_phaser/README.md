...
`shell_proof_phaser` is a v2 game scaffold created with `npm run create-game -- shell_proof_phaser`.
...
- `npm run typecheck -w @fabrikav2/shell_proof_phaser`
- `npm run test:unit -w @fabrikav2/shell_proof_phaser`
- `npm run audit`
