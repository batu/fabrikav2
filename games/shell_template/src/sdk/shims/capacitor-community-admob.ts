/** Web/CI resolver for the SDK's optional AdMob enum import. shell_template never calls
...
const unavailable = (): never => {
  throw new Error('@capacitor-community/admob is native-only (shell_template web stub)');
};
