...
const completeEnv = {
  ...
  VITE_FIREBASE_PROJECT_ID: 'find-the-bird-basegamelab',
  VITE_FIREBASE_APP_ID: 'firebase-app-id',
  VITE_FIREBASE_AUTH_DOMAIN: 'find-the-bird-basegamelab.firebaseapp.com',
  VITE_FIREBASE_STORAGE_BUCKET: 'find-the-bird-basegamelab.firebasestorage.app',
...
describe('Firebase app composition', () => {
  ...
  it('initializes the default Firebase app from the configured Bird project', () => {
    ...
    expect(initializeApp).toHaveBeenCalledWith({
      apiKey: 'api-key',
      projectId: 'find-the-bird-basegamelab',
      appId: 'firebase-app-id',
      authDomain: 'find-the-bird-basegamelab.firebaseapp.com',
      storageBucket: 'find-the-bird-basegamelab.firebasestorage.app',
