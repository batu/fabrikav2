...
export const canonicalAnalyticsEvents = [
  ...
  },
  {
    ...
    gameAnalyticsName: 'Progression start find_the_bird:<level_id>',
    family: 'progression',
    panel: 'level_funnel',
  ...
  },
  {
    ...
    gameAnalyticsName: 'Progression complete find_the_bird:<level_id>',
    family: 'progression',
    panel: 'level_funnel',
  ...
  },
  {
    ...
    gameAnalyticsName: 'Progression fail find_the_bird:<level_id>',
    family: 'progression',
    panel: 'level_funnel',
  ...
  },
  {
    ...
    family: 'design',
    panel: 'level_funnel',
    question: 'Soft churn inside an active level: backgrounded or torn down before completion.',
    primaryDimensions: ['level_id', 'sequence_slot', 'reason'],
    instrumentationStatus: 'runtime',
    successBoundary: 'GameScene suspends or shuts down while a started level is neither complete nor failed.',
    allowedGameAnalyticsCustomFields: ['level_index', 'elapsed_ms', 'found_count', 'total_count'],
  },
  // Between-level flow (handoff 2026-09-14): the completion screen, the action
  // that leaves it, the interstitial cadence decision, and the next level's
  // first frame. Every event carries level_index so the funnel cuts at 3 -> 4.
  {
    id: 'level_complete_shown',
    firebaseName: 'level_complete_shown',
    gameAnalyticsName: 'level_complete:shown',
    family: 'design',
    panel: 'level_funnel',
    question: 'How many completions reach the level-complete screen, and how long after level_start.',
    primaryDimensions: ['level_id', 'sequence_slot'],
    instrumentationStatus: 'runtime',
    successBoundary: 'The level-complete overlay is mounted.',
    allowedGameAnalyticsCustomFields: ['level_index', 'levels_completed_session', 'duration_ms'],
  },
  {
    id: 'level_complete_action',
    firebaseName: 'level_complete_action',
    gameAnalyticsName: 'level_complete:action',
    family: 'design',
    panel: 'level_funnel',
    question: 'How players leave the level-complete screen (next, claim_x2, rate_prompt, background, dismissed_by_shutdown) and how long they dwell.',
    primaryDimensions: ['level_id', 'sequence_slot', 'action'],
    instrumentationStatus: 'runtime',
    successBoundary: 'The player taps Next, the app is backgrounded on the overlay, or the scene tears the overlay down.',
    allowedGameAnalyticsCustomFields: ['level_index', 'dwell_ms', 'reward_revealed'],
    alertWhen: 'background or dismissed_by_shutdown actions dominate a level index.',
  },
  {
    id: 'interstitial_gate',
    firebaseName: 'interstitial_gate',
  ...
  },
  {
    ...
    gameAnalyticsName: 'ad:lifecycle',
    family: 'ad',
    panel: 'ads',
    ...
    allowedGameAnalyticsCustomFields: ['level_index', 'attempt', 'cache_age_ms'],
    alertWhen: 'load_failed or skipped stages dominate an eligible placement, or impressions lag shown.',
  },
  {
    id: 'next_level_ready',
    firebaseName: 'next_level_ready',
    gameAnalyticsName: 'level:next_ready',
    family: 'design',
    panel: 'level_funnel',
    question: 'How long the gap is between leaving the completion screen and the next level rendering its first frame, with and without an interstitial.',
    primaryDimensions: ['level_id', 'sequence_slot', 'after_interstitial'],
    instrumentationStatus: 'runtime',
    successBoundary: 'The restarted GameScene renders its first frame after a level_complete_action.',
    allowedGameAnalyticsCustomFields: ['level_index', 'gap_ms'],
  },
  {
    id: 'bird_collected',
    firebaseName: 'bird_collected',
    gameAnalyticsName: 'bird:collected',
    family: 'design',
    panel: 'retention',
    question: 'Which species players actually accumulate, and how fast the collection ladder moves.',
    primaryDimensions: ['bird_type', 'level_id'],
    instrumentationStatus: 'runtime',
    successBoundary: 'A tagged bird is accepted by gameplay and its lifetime counter is persisted.',
    allowedGameAnalyticsCustomFields: ['bird_type', 'level_id', 'total'],
  },
  {
    id: 'sanctuary_house',
    firebaseName: 'sanctuary_house',
    gameAnalyticsName: 'sanctuary:house',
    family: 'design',
    panel: 'economy',
    question: 'How far players climb the Sanctuary house tiers, and how long each tier takes to afford.',
    primaryDimensions: ['tier'],
    instrumentationStatus: 'runtime',
    successBoundary: 'Coins were spent and the house tier advanced.',
    allowedGameAnalyticsCustomFields: ['tier', 'price'],
  },
  {
    id: 'sanctuary_collect',
    firebaseName: 'sanctuary_collect',
    gameAnalyticsName: 'sanctuary:collect',
    family: 'design',
    panel: 'economy',
    question: 'How much of the idle coin drip players actually return for.',
    primaryDimensions: ['tier'],
    instrumentationStatus: 'runtime',
    successBoundary: 'Pending coins were banked into the wallet.',
    allowedGameAnalyticsCustomFields: ['coins', 'tier'],
  },
  {
    id: 'dog_found',
  ...
  },
  {
    ...
    primaryDimensions: ['product_id', 'surface'],
    instrumentationStatus: 'runtime',
    successBoundary: 'Native purchase flow is requested.',
  },
  {
    id: 'purchase_sheet_shown',
    firebaseName: 'purchase_sheet_shown',
    gameAnalyticsName: 'purchase:sheet_shown',
    family: 'design',
    panel: 'store',
    question: 'Did the tap actually reach the native payment sheet dispatch?',
    primaryDimensions: ['product_id'],
    instrumentationStatus: 'runtime',
    successBoundary: 'IapService dispatched the provider purchase call.',
  },
  {
  ...
  },
  {
    ...
    primaryDimensions: ['product_id', 'reason', 'surface', 'failure_kind'],
    instrumentationStatus: 'runtime',
  ...
  {
    id: 'iap_state_changed',
    firebaseName: 'iap_state_changed',
    gameAnalyticsName: 'iap:state_changed',
    family: 'design',
    panel: 'quality',
    question: 'IAP init health — did the store pipeline reach ready, and why not?',
    primaryDimensions: ['state', 'reason'],
    instrumentationStatus: 'runtime',
    successBoundary: 'IapService state machine transitioned.',
    alertWhen: 'load-failed or ready-with-zero-products appears at scale.',
  },
  {
