...
`shell_proof_grapes` is a v2 game scaffold created with `npm run create-game -- shell_proof_grapes`.
...
- `npm run typecheck -w @fabrikav2/shell_proof_grapes`
- `npm run test:unit -w @fabrikav2/shell_proof_grapes`
- `npm run audit`
