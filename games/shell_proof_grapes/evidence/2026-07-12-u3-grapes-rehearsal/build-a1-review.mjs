...
<dialog class="a1-review-dialog" id="a1-review-dialog" aria-labelledby="a1-review-title">
  <header class="a1-review-header">
    <div>
      ...
      <p>Exercise the editor first, then record your verdict. It carries the exact validated seven-surface V2 project so downstream lane work begins from what you accepted.</p>
      <details class="a1-review-details">
        <summary>Technical details</summary>
        <p>The verdict also carries the saved project hash and the reviewed full asset-catalog hash for shell_proof_grapes. Portal transports the decision but never becomes the design authority.</p>
      </details>
    </div>
  ...
  <form class="a1-review-form" id="a1-review-form">
    <fieldset class="a1-review-checks">
      <legend>Representative V2 edit set</legend>
      <label class="a1-review-check"><input type="checkbox" name="check" value="seven_surfaces">Review all seven surfaces, including Shop</label>
...
(() => {
  ...
  async function decide(decision) {
    ...
    const payload = {
      schema: "fabrikav2-grapes-shell-a1-v2",
      decision,
