...
and the generated `design/copy.ts` / `design/assets.ts` modules. `TemplateShell`
is the editor-neutral six-surface reference; a real game replaces only the
mechanic-neutral gameplay region while retaining the shell state owner.
