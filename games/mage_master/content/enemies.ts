...
/**
 * Level-1 grunt template. Crit/dodge/block are RATING points (combat math
 * v0.2); Health absorbs the removed DEF stat (HP × (100 + DEF) / 100).
 */
...
export const ENEMIES: readonly EnemyDefinition[] = [
  ...
  },
  {
    ...
    boss: false,
    base: grunt({ hp: 82, atk: 18, atkSpeed: 0.8, moveSpeed: 55 }),
    reach: 210,
    scale: 0.84,
  ...
  },
  {
    ...
    boss: true,
    base: grunt({ hp: 1035, atk: 40, atkSpeed: 0.7, moveSpeed: 50, block: 11 }),
    reach: 40,
    scale: 1.6,
  ...
  },
  {
    ...
    boss: false,
    base: grunt({ hp: 104, atk: 20, atkSpeed: 1.4, moveSpeed: 110, dodge: 9 }),
    reach: 30,
    scale: 0.92,
  ...
  },
  {
    ...
    boss: true,
    base: grunt({ hp: 1344, atk: 55, atkSpeed: 1.2, moveSpeed: 90, dodge: 11 }),
    reach: 42,
    scale: 1.7,
  ...
  },
  {
    ...
    boss: false,
    base: grunt({ hp: 173, atk: 12, atkSpeed: 0.6, moveSpeed: 40 }),
    reach: 28,
    scale: 0.82,
  ...
  },
  {
    ...
    boss: true,
    base: grunt({ hp: 2250, atk: 45, atkSpeed: 0.5, moveSpeed: 35, block: 18 }),
    reach: 46,
    scale: 1.9,
...
/** Per-level multipliers: hp and atk compound; stage index nudges both. Ratings never scale. */
