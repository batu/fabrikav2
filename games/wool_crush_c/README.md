...
`wool_crush_c` is a v2 game scaffold created with `npm run create-game -- wool_crush_c`.
...
- `npm run typecheck -w @fabrikav2/wool_crush_c`
- `npm run test:unit -w @fabrikav2/wool_crush_c`
- `npm run audit`
