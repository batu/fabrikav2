...
export const canonicalAnalyticsEvents = [
  ...
  },
  {
    ...
    gameAnalyticsName: 'Progression start marble_run:<level_id>',
    family: 'progression',
    panel: 'level_funnel',
  ...
  },
  {
    ...
    gameAnalyticsName: 'Progression complete marble_run:<level_id>',
    family: 'progression',
    panel: 'level_funnel',
  ...
  },
  {
    ...
    gameAnalyticsName: 'Progression fail marble_run:<level_id>',
    family: 'progression',
    panel: 'level_funnel',
