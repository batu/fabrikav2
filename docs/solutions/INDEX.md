...
- 2026-07-13 — [anchor-verification-gate-trust-outside-audited-artifact](architecture-patterns/anchor-verification-gate-trust-outside-audited-artifact.md) — a verification gate must anchor its trust outside the artifact it audits (two-commit seal, policy-from-base, base != HEAD)
