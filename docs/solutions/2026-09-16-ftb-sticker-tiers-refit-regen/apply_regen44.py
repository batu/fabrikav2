...
from common import *
O=SCRATCH/'regen44'; r1={(r['level'],r['bird']):(r,'crop','sunburst_cutout') for r in json.load(open(O/'runs.json'))}; r2={(r['level'],r['bird']):(r,'crop2','sunburst2_cutout') for r in json.load(open(O/'runs2.json')) if r.get('fit')}
