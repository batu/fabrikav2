...
// findings in docs/evidence/2026-07-06-1747-rigorous-diff/findings.json + the per-
...
const findings = JSON.parse(
  fs.readFileSync(path.join(REPO, 'docs/evidence/2026-07-06-1747-rigorous-diff/findings.json'), 'utf8'),
).findings;
...
<a href="../2026-07-06-1747-rigorous-diff/report.html">rigorous paired diff</a> after the fidelity fixes
...
<code>2026-07-06-1747-rigorous-diff/findings.json</code> + <code>integrity.json</code> + the recaptured
