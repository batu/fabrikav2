...
| deterministic build | two consecutive production builds and `cmp` | passed: byte-identical manifest; deployed scroll-affordance artifact content hash `e6a20c180c661c54555afabc8c6bedba377ffeb7e5d1d7e16a715787aaae64bc` |
