...
| Portal live focus semantics | same authenticated route, content hash `e31f639f5eccdf61e0777e0627a91423a4ae9cd27e23701e7cbc165d5117effa` | passed: Practice has no focus control; a mechanic debut shows truthful emphasis copy; removing or moving the mechanic clears its focus state; zero page errors; [capture](plain-language-review/pattern-focus-live-fixed-1440.png) |
