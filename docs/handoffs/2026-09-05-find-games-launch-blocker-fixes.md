...
- N2: canonical external collector now requires successful navigation, matching document loader/project URL, complete non-demo content and a valid DAU before labeling the GA snapshot healthy. Failed identity/navigation stays unavailable/null. An [evidence copy](../evidence/2026-09-05-find-games-launch-blocker-fixes/README.md) is included; do not run it as another collector.
