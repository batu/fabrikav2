 ...
 *
 * NOTE (carry): copied from find_the_dog's `utils/withTimeout.ts`. This is a
 * cross-SDK primitive (ads/attribution/analytics/IAP all bound native calls
 * with it) — its eventual home is `@fabrikav2/kernel`. Carried locally here to
 * keep this card surgical; a later card should promote it rather than
 * quadruplicate it. */
